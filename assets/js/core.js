    ...
    cart.forEach((item, index) => {
      ...
      li.innerHTML = `
        <div class="cart-item">
          ...
          <button class="cart-remove" data-index="${index}"><svg class="s4l-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:-4px;flex-shrink:0;"><path d="M6 6l12 12M18 6L6 18"/></svg></button>
        </div>
      `;
